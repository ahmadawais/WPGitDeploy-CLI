...
# E.g. PLUGIN_SLUG="cf7-customizer" for https://wordpress.org/plugins/cf7-customizer/
PLUGIN_SLUG="plugin-slug"

# GITHUB user who owns the repo (You or your company)
GITHUB_REPO_OWNER="WPTie"

# GITHUB Repository name
# E.g. https://github.com/WPTie/CF7Customizer
GITHUB_REPO_NAME="CF7Cutomizer"
...
# LIST BRANCHES
clear
echo "Fetching the git branches."
git fetch origin
...
then
	...
	echo "Tag already exists, let's remove it and recreate it."
	svn delete tags/${VERSION} || { echo "Unable to delete the tag."; exit 1; }
	echo "Creating the tag again."
	svn copy trunk tags/${VERSION} || { echo "Unable to create tag."; exit 1; }
fi
